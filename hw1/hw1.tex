...
\end{equation} 
où $F_{\mu\nu}$ est le champ électromagnétique
\begin{equation}\label{eq:F}
        F_{\mu\nu} = \partial_{\mu}A_\nu - \partial_{\nu}A_\mu\, .
\end{equation} 
...
\end{align}
%La variation infinitésimale de l'action de Maxwell sous l'effet d'une transformation de jauge est
%\begin{align*}
        %\delta S &= \int d^{d+1}x\, \delta\mathcal{L}(\partial_{\mu}A_\nu) \\[2ex]
        %&= \int d^{d+1}x\, \frac{\partial \mathcal{L}}{\partial (\partial_{\mu}A_\nu)} \delta (\partial_{\mu}A_{\nu} + \partial_{\mu}f) \\[2ex]
        %&= \int d^{d+1}x\, \frac{\partial \mathcal{L}}{\partial (\partial_{\mu}A_\nu)} \delta (\partial_{\mu}A_{\nu} + \partial_{\mu}f) \\[2ex]
%\end{align*}
